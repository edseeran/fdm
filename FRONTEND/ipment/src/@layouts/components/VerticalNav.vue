...
const logout = async () => {
  const csrftoken = userStore.getToken;
  try {
    ...
    // Clear session and CSRF token cookies
  ...
  >
    ...
    <div class="nav-header">
      <slot name="nav-header">
        <RouterLink to="/apps/ipm/main-dashboard" class="app-logo app-title-wrapper">
    ...
    <slot>
      <VBtn color="error" class="mx-5 mb-5" append-icon="tabler-logout" @click="logout()">
        Logout
      </VBtn>
    </slot>
  </Component>
