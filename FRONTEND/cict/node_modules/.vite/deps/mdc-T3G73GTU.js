...
var lang = Object.freeze({ "displayName": "MDC", "injectionSelector": "L:text.html.markdown", "name": "mdc", "patterns": [{ "include": "#component_block" }, { "include": "#inline" }], "repository": { "attribute": { "patterns": [{ "captures": { "2": { "name": "entity.other.attribute-name.html" }, "3": { "patterns": [{ "include": "#attribute-interior" }] } }, "match": `(?x)
(
([^=><\\s]*)
(
=["]([^"]*)(["])|[']([^']*)(['])
...
//# sourceMappingURL=mdc-T3G73GTU.js.map
